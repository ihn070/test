...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav, landingPageNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={landingPageNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
